...
public final class CameraConfigurationUtils {
     ...
     */
    public static Point findBestSize(Camera.Parameters parameters, int surfaceWidth, int surfaceHeight, List<Camera.Size> preSizeList, Point screenResolution) {
        if (preSizeList == null || preSizeList.isEmpty()) {
